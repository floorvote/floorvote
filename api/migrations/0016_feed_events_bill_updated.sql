-- Add suppressed column and bill_updated to type CHECK constraint
...
INSERT INTO feed_events_new (id, type, bill_id, user_id, metadata, created_at)
SELECT id, type, bill_id, user_id, metadata, created_at FROM feed_events;
