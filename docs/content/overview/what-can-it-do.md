...
Team members record how they feel about a bill by voting support, oppose, or neutral. Voting is semi-private: individual members see the team's aggregate results, while admins can see how each person voted.

Prioritized bills show up right in each member's sidebar as a standing reminder, so a bill that matters doesn't just sit there waiting for someone to notice it needs a vote.

## Commenting

Team members can discuss any bill directly on its page with comments and reactions, so the conversation about a bill lives next to the bill itself instead of scattered across email threads. Alongside comments, each member can also keep private notes on a bill, visible only to them, for the kind of personal reminder you wouldn't want to post to the whole team.
...
Members get notified about updates to the bills they've prioritized, and anyone @-mentioned in a comment gets a notification pointing them straight to it.

For anyone who'd rather not check FloorVote constantly, periodic email digests round up what's changed, and a week-ahead email flags upcoming hearings before they sneak up on you.
