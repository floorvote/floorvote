...
Two interactive diagrams are the exception, since GitHub renders `.html` as source rather than as a page: the <a href="/docs/internal/architecture.html" target="_self">architecture dossier</a> and the <a href="/docs/internal/sync-flow.html" target="_self">sync flow</a> are served here as standalone pages.
