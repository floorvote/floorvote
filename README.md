...
FloorVote is open source under [AGPL-3.0](LICENSE). Contributions are accepted under the [Developer Certificate of Origin](DCO) — sign your commits with `git commit -s`. If you run a modified version as a network service, the AGPL requires you to offer your users the corresponding source.
